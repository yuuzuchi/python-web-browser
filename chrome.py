...
class Chrome:
    def __init__(self, browser: Browser):
        ...
        self.back_rect = Rect(
            ...
            self.padding + self.NAV_WIDTH,
            self.urlbar_bottom - self.padding,
        )
        self.forward_rect = Rect(
            self.back_rect.right + self.padding,
            self.urlbar_top + self.padding,
            self.back_rect.right + self.padding + self.NAV_WIDTH,
            self.urlbar_bottom - self.padding,
        )
        self.address_rect = Rect(
            self.forward_rect.right + self.padding,
            self.urlbar_top + self.padding,
            self.browser.canvas.winfo_width() - self.padding,
            self.urlbar_bottom - self.padding,
        )
    ...
    def paint(self):
        ...
        cmds.append(
            DrawLine(
                0,
                self.bottom,
                self.browser.canvas.winfo_width(),
                self.bottom,
                "black",
                1,
            )
    ...
    def paint_tabs(self):
        ...
        for i, tab in enumerate(self.browser.tabs):
            ...
            out.append(DrawLine(bounds.left, 0, bounds.left, bounds.bottom, "black", 1))
            out.append(
